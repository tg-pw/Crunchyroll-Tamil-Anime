...
# from Ashu.utils.bot_utils import gen_linkx, verify_user
# from Ashu.config import Telegram
...
# @Ashu.on_message(filters.command('start') & filters.private)
...
#                 caption=LANG.START_TEXT.format(message.from_user.mention, Ashu.username),
#                 parse_mode=ParseMode.HTML,
#                 reply_markup=BUTTON.START_BUTTONS
#             )
#         else:
#             await message.reply_text(
#                 text=LANG.START_TEXT.format(message.from_user.mention, Ashu.username),
#                 parse_mode=ParseMode.HTML,
...
# @Ashu.on_message(filters.private & filters.command(["about"]))
...
#         await message.reply_photo(
#             photo=Telegram.START_PIC,
#             caption=LANG.ABOUT_TEXT.format(Ashu.fname, __version__),
#             parse_mode=ParseMode.HTML,
...
# @Ashu.on_message((filters.command('help')) & filters.private)
...
# @Ashu.on_message(filters.command('files') & filters.private)
